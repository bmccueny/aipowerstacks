...
alter table public.tools add column if not exists verified_by_admin boolean default false;
alter table public.tools add column if not exists admin_review_video_url text;
alter table public.tools add column if not exists admin_review_notes text;
alter table public.tools add column if not exists admin_review_at timestamptz;

-- Update the search function return type again
