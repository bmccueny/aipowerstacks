...
export function BlueprintRequestModal({ children }: { children: React.ReactNode }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px] rounded-2xl border border-border backdrop-blur-xl bg-background/90">
        {!submitted ? (
          <>
            <DialogHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 mt-4">
              <div className="space-y-2">
                ...
                <textarea 
                  ...
                  className="w-full min-h-[100px] rounded-xl border border-border bg-background p-3 text-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 transition-all"
                  value={goal}
