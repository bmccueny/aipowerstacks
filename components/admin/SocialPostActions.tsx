    ...
    return (
      <div className="space-y-3 mt-3">
        <textarea
          ...
          rows={4}
          maxLength={280}
          className="w-full bg-background border border-border/50 rounded-lg px-3 py-2 text-sm resize-none focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/20"
        />
