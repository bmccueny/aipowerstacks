...
function ToolCardList({
  ...
  return (
    <div className="glass-card rounded-xl px-5 py-4 flex flex-wrap sm:flex-nowrap items-center gap-4 group relative cursor-pointer">
...
function ToolCardGrid({
  ...
  return (
    <div className="relative card-directory h-full flex flex-col group">
...
export function ToolCard({
  ...
  // ⚡ Bolt Optimization: Removed unused `hasBeenHovered` state and its `onMouseEnter` trigger
  // to prevent unnecessary React re-renders when a user hovers over the card.
