...
export const ToolCard = memo(
  function ToolCard({
    ...
    const screenshotUrl =
      (tool.screenshot_urls as string[] | null)?.[0] ?? null;
  ...
  function arePropsEqual(prevProps, nextProps) {
    ...
    // Instead of exhaustive individual checks, we can iterate over the keys to shallow compare all primitive values
    // For arrays, we do a length check and shallow check.
