...
/**
 * Memoized ToolCard to prevent unnecessary re-renders in large grids.
 * Checks primitive props and the tool ID since tool objects may be re-created on server fetch.
 */
