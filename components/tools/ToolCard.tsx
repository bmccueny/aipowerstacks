...
// Memoized component to prevent unnecessary re-renders in lists (e.g., ToolGrid)
// We provide a custom comparison function checking specific properties (like ID, display primitives, pricing, etc).
