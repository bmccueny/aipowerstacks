        ...
        <div className="flex flex-wrap gap-1.5">
          {recent.map((term) => (
            <button
              ...
              className="rounded-full border border-border px-3 py-2 text-[11px] text-muted-foreground hover:text-foreground hover:border-foreground/25 transition-colors"
            >
              {term}
            </button>
          ))}
