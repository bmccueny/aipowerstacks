[Skip to content](https://nesslabs.com/how-to-think-better#content "Skip to content")
...
- [Critical thinking principles](https://nesslabs.com/how-to-think-better#principles)
- [Decision-making frameworks](https://nesslabs.com/how-to-think-better#frameworks)
- [Tools for thought](https://nesslabs.com/how-to-think-better#tools)
...
![Principles to think better ](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20859%20439'%3E%3C/svg%3E)How to think better: key principles (green = do more; red = do less)
...
![How to think better with the Eisenhower matrix of prioritisation](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20432%20434'%3E%3C/svg%3E)
...
- **Mapping tools.** Whether you create [mind maps or concept maps](https://nesslabs.com/mental-atlas), visual graphs are a great way to consolidate your thinking. While there are some cool apps, you don’t need anything fancy to start [thinking in maps](https://nesslabs.com/thinking-in-maps); pen and paper will do. However, if you do want a more powerful too, my favourite one is [Scapple](https://www.literatureandlatte.com/scapple/overview) (by the same developers as the writing tool Scrivener). I used it to create [this mental map](https://twitter.com/anthilemoon/status/1307644327468978177).
...
Ultimately, the process itself of learning how to think better requires hard work, but it can be fun and fulfilling. Identifying your cognitive biases, deciding which mental models to apply, and having thought-provoking conversations with fellow curious minds is an enriching experience, where the journey matters more than the destination. Good thinking is the result of [deliberate practice](https://nesslabs.com/deliberate-practice). So take your time, and [fail like a scientist](https://nesslabs.com/fail-like-a-scientist). Good thinking is a precious skill it is worth investing in.
...
[✨ Better Thinking](https://nesslabs.com/topic/thinking) [? Healthy Mind](https://nesslabs.com/topic/mental-health) [‍? Meaningful Living](https://nesslabs.com/topic/life) [? Purposeful Creativity](https://nesslabs.com/topic/creativity) [⛰️ Continuous Learning](https://nesslabs.com/topic/learning) [?️ Tools for Thought](https://nesslabs.com/topic/tools) [? Search](https://nesslabs.com/search)

Ness Labs © 2025. [All rights reserved](https://nesslabs.com/copyright-notice).

[About](https://nesslabs.com/about) [Contact](https://nesslabs.com/contact) [Press](https://nesslabs.com/press) [Hosting](https://www.dreamhost.com/r.cgi?2429493/wordpress/) [Privacy Policy](https://nesslabs.com/privacy)

[Scroll back to top](https://nesslabs.com/how-to-think-better# "Scroll back to top")