...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      ...(profile?.avatar_url ? { images: [{ url: profile.avatar_url, width: 200, height: 200, alt: displayName }] } : { images: [{ url: `${SITE_URL}/og-home-v2.jpg`, width: 1200, height: 630, alt: 'AIPowerStacks' }] }),
    },
    twitter: {
      card: 'summary',
      site: '@aipowerstacks',
