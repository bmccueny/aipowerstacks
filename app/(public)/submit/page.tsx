    ...
    return (
      <div className="max-w-2xl mx-auto px-4 py-12">
        <div className="glass-card rounded-3xl p-6 sm:p-8 mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-black mb-2">Sign In To Submit A Tool</h1>
          <p className="text-muted-foreground">
            To reduce spam and keep listings high quality, submitting, claiming, or editing a tool requires an account.
          </p>
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      <div className="glass-card rounded-3xl p-6 sm:p-8 mb-8">
        ...
        <h1 className="text-3xl sm:text-4xl font-black mb-2">Submit an AI Tool</h1>
        <p className="text-muted-foreground">
          {intro}
        </p>
      </div>
