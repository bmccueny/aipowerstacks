      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 flex flex-col justify-center p-8 lg:p-24 max-w-2xl mx-auto w-full">
          <div className="mb-12">
            ...
            <p className="text-lg font-medium opacity-60">Start saving your favorite AI tools today.</p>
          </div>
            ...
            <form onSubmit={handleRegister} className="space-y-8">
              <fieldset className="group">
                <legend className="w-full mb-3 flex items-center justify-between">
                  <span className="text-sm font-black uppercase tracking-widest opacity-60">Full Name</span>
                </legend>
              ...
              <fieldset className="group">
                <legend className="w-full mb-3 flex items-center justify-between">
                  <span className="text-sm font-black uppercase tracking-widest opacity-60">Username</span>
                </legend>
                <div className="relative bg-white border-2 border-black rounded-sm shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all focus-within:translate-x-[-2px] focus-within:translate-y-[-2px] focus-within:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
                  <span className="absolute left-6 top-1/2 -translate-y-1/2 text-lg font-bold opacity-30">@</span>
                  <input
                    type="text"
                    value={username}
                    ...
                    required
                    className="w-full h-14 pl-12 pr-6 bg-transparent font-bold text-lg focus:outline-none placeholder:opacity-30"
                  />
                </div>
              </fieldset>
      ...
      <div className="hidden lg:block w-[40vw] border-l-2 border-black relative overflow-hidden bg-[#ffc900]">
         ...
         <div className="absolute inset-0 flex items-center justify-center p-20 text-center">
            <div className="space-y-6">
               ...
               <h2 className="text-5xl font-black tracking-tight leading-none mt-12">Built by creators, for creators.</h2>
               <p className="text-xl font-bold opacity-80 max-w-sm mx-auto">Discover the perfect stack for your next big AI project.</p>
            </div>
         </div>
      </div>
    </div>
