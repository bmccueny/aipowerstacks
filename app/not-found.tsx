  ...
  return (
    <div className="page-shell flex flex-col items-center justify-center min-h-[60vh] text-center space-y-6">
      ...
      <div className="flex flex-wrap justify-center gap-3">
        <Link
          href="/"
          className="inline-flex items-center gap-2 px-4 py-2 rounded-md glass-card border border-border hover:border-foreground/20 transition-colors text-sm font-medium"
        >
